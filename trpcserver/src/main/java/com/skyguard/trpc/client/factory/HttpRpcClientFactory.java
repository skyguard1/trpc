...
import com.skyguard.trpc.http.netty.client.NettyHttpClient;
...
public class HttpRpcClientFactory implements TrpcClientFactory{

    private static Map<String,TrpcClient> clientMap = new ConcurrentHashMap<>();

    private CommonRpcClient rpcClient = new NettyHttpClient();
